...
@Slf4j
public class CooperativeStickyPartitionAssignorConsumer {
  ...
  public static void start(String instanceId, List<String> event) {
    ...
    Map<String, Object> consumerConfig = Map.of(
        ...
        ConsumerConfig.GROUP_ID_CONFIG, "CooperativeStickyPartitionAssignorConsumerGroup", // groupId
        ConsumerConfig.GROUP_INSTANCE_ID_CONFIG, instanceId, // identifier for a consumer in consumer group.
        ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG, CooperativeStickyAssignor.class.getName() // setting partition strategy as CooperativeStickyAssignor
    );
