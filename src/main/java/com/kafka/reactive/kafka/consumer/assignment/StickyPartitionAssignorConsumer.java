...
@Slf4j
public class StickyPartitionAssignorConsumer {
  ...
  public static void start(String instanceId, List<String> event) {
    ...
    Map<String, Object> consumerConfig = Map.of(
        ...
        ConsumerConfig.GROUP_ID_CONFIG, "StickyPartitionAssignorConsumerGroup", // groupId
        ConsumerConfig.GROUP_INSTANCE_ID_CONFIG, instanceId, // identifier for a consumer in consumer group.
        ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG, StickyAssignor.class.getName() // setting partition strategy as StickyAssignor
    );
